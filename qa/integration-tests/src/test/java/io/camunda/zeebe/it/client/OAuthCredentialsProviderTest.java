...
final class OAuthCredentialsProviderTest {
  ...
  private String getTokenEndpoint() {
    return String.format(
        ...
        oauthContainer.getContainerIpAddress(), oauthContainer.getMappedPort(PUBLIC_PORT));
  }
  ...
  private URI getAdminEndpoint(final String path) {
    final var endpoint =
        String.format(
            "http://%s:%d/%s",
            oauthContainer.getContainerIpAddress(), oauthContainer.getMappedPort(ADMIN_PORT), path);
